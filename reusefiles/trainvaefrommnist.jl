...
function trainvaefromMNIST()
    ...
    trainvalidatelognsave(loss, vaemodel, params(vaemodel), trainloader, testloader, Flux.Optimise.ADAM(0.0001), 100, "./reusefiles/models/", "./reusefiles/logs/", saveinterval=10, validateinterval=5)
end
