...
firstplot, secondplot = plot_MNISTrecoveries([recoversignal, relaxed_recover], model, logrange(64, 784, 5), [2, 9], optimlayers=[2], inrange=false, tolerance=5.0f-4, max_iter=3000, lr=0.1f0)
firstplot
secondplot
